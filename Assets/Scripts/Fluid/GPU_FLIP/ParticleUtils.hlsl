#ifndef PARTICLE_UTILS_HLSL
#define PARTICLE_UTILS_HLSL
...
void Geometry(point v2g p[1], inout TriangleStream<g2f> stream)
{
    ...
    const float remap_speed = MyRemap(p[0].particle_data.w, _VelocityRange.x, _VelocityRange.y, 0, 1);
