...
namespace Abecombe.GPUUtil
{
    ...
    {
        public GPUBuffer<T> Read { get; private set; } = new GPUBuffer<T>();
        public GPUBuffer<T> Write { get; private set; } = new GPUBuffer<T>();
    ...
    {
        public GPUTexture2D Read { get; private set; } = new GPUTexture2D();
        public GPUTexture2D Write { get; private set; } = new GPUTexture2D();
    ...
    {
        public GPUTexture3D Read { get; private set; } = new GPUTexture3D();
        public GPUTexture3D Write { get; private set; } = new GPUTexture3D();
        public int Width => Read.Width;
        public int Height => Read.Height;
    ...
    public class GPUComputeShader
    {
        ...
        private Dictionary<string, GPUKernel> _kernels = new Dictionary<string, GPUKernel>();
    ...
    public static class GPUCastTool
    {
        ...
        public static Vector4 ToVector(this uint2 i2) => new Vector4(i2.x, i2.y);
        public static Vector4 ToVector(this uint3 i3) => new Vector4(i3.x, i3.y, i3.z);
        public static Vector4 ToVector(this uint4 i4) => new Vector4(i4.x, i4.y, i4.z, i4.w);
