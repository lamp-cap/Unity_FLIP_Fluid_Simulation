...
namespace Abecombe.GPUBufferOperators
{
    public class GPUFiltering : IDisposable
    {
        ...
        private GPUPrefixScan _prefixScan = new GPUPrefixScan();
        ...
        public void Dispose()
        {
            if (_tempBuffer != null) { _tempBuffer.Release(); _tempBuffer = null; }
            if (_groupSumBuffer != null) { _groupSumBuffer.Release(); _groupSumBuffer = null; }
            if (_globalPrefixSumBuffer != null) { _globalPrefixSumBuffer.Release(); _globalPrefixSumBuffer = null; }
