#ifndef _MARCHING_CUBES_HLSL_
#define _MARCHING_CUBES_HLSL_
...
static const uint TriangleVertCountTable[] =
{
...
static const uint CubeEdgeFlags[] =
{
...
static const uint CellVertOffsetTable[] = 
{
    ...
    2358, 2364, 2373, 2382, 2388, 2397, 2409, 2415, 2418, 2427, 2433, 2445, 2448, 2454, 2457, 2460
};
static const uint TriangleConnectionTable[] = 
{
...
inline uint GetVertCount(uint flag)
{
    return TriangleVertCountTable[flag];
}

inline uint GetVertIdx(uint flag, uint idx)
{
    return TriangleConnectionTable[CellVertOffsetTable[flag] + idx];
}
#endif